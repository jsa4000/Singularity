...
# In this case it would be useful to think in a structure that will be independent for the platform/technology, easy to change/modifiy and flexible.
# Also I need to think in responses or images generated from this graphs. So Firstly I need to get a Neural Network work and then think in how the results and
# outputs will be stored from that graph

# In first instance eacn parameter stores it last value. However there is no historic or resume to track the graph.It should be useful that each parameter store the global history
# of the process
...
#           GRAPHS
#               NODES (NODES, ASSEMBLIES, TEMPLATES, etc..)
#               PARAMETERS (PARAMETERS)
#       CUSTOM_NODES (ASSETS, TEMPLATES)
#             GRAPHS
#                NODES 
#                PARAMETERS
...
# ASSEMBLIES are nodes that have connection to another nodes.
